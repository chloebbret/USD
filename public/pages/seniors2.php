...
<h1 style="color: white; display: flex; justify-content: center; margin-top: 1em; font-size: 70px">SENIORS 2</h1>

<div class="teamPhoto">
    <img src="../img/seniors2.jpg" alt="" class="team">
</div>
...
<div class="role-section">
    <div class="item">
        <img src="../img/quentin.jpg" alt="Quentin GARAVEL" class="staff">
        <div class="overlay">
            <div class="info">
                <span class="name">Quentin GARAVEL</span><br>
            </div>
        </div>
    </div>
    <div class="item">
        <img src="../img/steph.jpg" alt="Stéphane MONTET" class="staff">
        <div class="overlay">
            <div class="info">
                <span class="name">Stéphane MONTET</span><br>
            </div>
        </div>
    </div>
</div>
