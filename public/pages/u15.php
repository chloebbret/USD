...
<h1 style="color: white; display: flex; justify-content: center; margin-top: 1em; font-size: 70px">U15</h1>

<div class="teamPhoto">
    <img src="../img/u15.jpg" alt="" class="team">
</div>
...
<div class="role-section">
    <div class="item">
        <img src="../img/benoit.jpg" alt="Benoit CLOITRE" class="staff">
        <div class="overlay">
            <div class="info">
                <span class="name">Benoit CLOITRE</span><br>
            </div>
        </div>
    </div>
    <div class="item">
        <img src="../img/fred.jpg" alt="Frédéric DUMAZOT" class="staff">
        <div class="overlay">
            <div class="info">
                <span class="name">Frédéric DUMAZOT</span><br>
            </div>
        </div>
    </div>
</div>
