...
<h1 style="color: white; display: flex; justify-content: center; margin-top: 1em; font-size: 70px">U9</h1>

<div class="teamPhoto">
    <img src="../img/u9.jpg" alt="" class="team">
</div>
...
<div class="role-section">
    <div class="item">
        <img src="../img/eric.jpg" alt="Eric JOUVE" class="staff">
        <div class="overlay">
            <div class="info">
                <span class="name">Eric JOUVE</span><br>
            </div>
        </div>
    </div>
    <div class="item">
        <img src="../img/coco.jpg" alt="Corentin CHAMARD BOIS" class="staff">
        <div class="overlay">
            <div class="info">
                <span class="name">Corentin CHAMARD BOIS</span><br>
            </div>
        </div>
    </div>
</div>
